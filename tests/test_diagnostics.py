...
class TestFastParseDiagnostics(unittest.TestCase):
    ...
    def print_error(self, test_name: str, error: Exception):
        """Helper to make terminal output readable."""
        print(f"\n{'='*20} {test_name} {'='*20}")
        print(str(error))
        print('=' * (42 + len(test_name)))

    def test_missing_required_args_formatting(self):
    ...
    def test_type_error_with_repr(self):
    ...
    def test_boolean_optimization_and_strictness(self):
    ...
    def test_non_interned_keyword_warning(self):
        """
    ...
    def test_u64_error_formatting(self):
