...
// =================================================================================================
static CULV_FORCE_INLINE void 
process_full_batch(PhysicsWorldObject *self, const SyncWorkItem *worklist) {
...
// =================================================================================================
static void process_partial_batch(PhysicsWorldObject *self, const SyncWorkItem *worklist, uint32_t count) {
    if (count == 0) return;
