"""
Type Stubs for the C-Extension (_culverin_c).
...
class PhysicsWorld:
    ...
    def create_compound_body(self, pos: Vec3, rot: Quat, parts: list[tuple[Vec3, Quat, int, Any]], motion: int = 2, mass: float = -1.0, user_data: int = 0, is_sensor: bool = False, category: int = 0xFFFF, mask: int = 0xFFFF, material_id: int = 0, friction: float = 0.2, restitution: float = 0.0, ccd: bool = False) -> int: ...
    ...
    def create_vehicle(self, chassis: int, wheels: list[dict[str, Any]], drive: str = "RWD", engine: Any = None, transmission: Any = None) -> Vehicle: ...
    def create_tracked_vehicle(self, chassis: int, wheels: list[dict[str, Any]], tracks: list[dict[str, Any]], max_torque: float = 5000.0, max_rpm: float = 6000.0) -> Vehicle: ...
