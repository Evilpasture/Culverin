...
class PhysicsWorld:
    ...
    def create_body(
        ...
        shape: int = 0,
        motion: int = 2,
        user_data: int = 0 # Match parameter 7
    ) -> int: ...
    ...
    def create_mesh_body(
        ...
        vertices: bytes,
        indices: bytes,
        user_data: int = 0 # Match parameter 6
    ) -> int: ...
    ...
    def raycast(self, start: Tuple[float, float, float], direction: Tuple[float, float, float], max_dist: float = 1000.0) -> Optional[Tuple[int, float]]: ...
