...
static JPH_WheelSettings *create_single_wheel(PyObject *w_dict,
  ...
  JPH_WheelSettings_SetSteeringAxis((JPH_WheelSettings *)w,
                                    &(JPH_Vec3){0, 1.0f, 0});
  ...
  JPH_WheelSettings_SetWheelForward((JPH_WheelSettings *)w,
                                    &(JPH_Vec3){0, 0, 1.0f});
...
// --- Main Function ---
// NOLINTNEXTLINE(readability-function-cognitive-complexity)
PyObject *PhysicsWorld_create_vehicle(PhysicsWorldObject *self, PyObject *args,
                                      PyObject *kwds) {
...
PyObject *Vehicle_set_input(VehicleObject *self, PyObject *args,
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwds, "|ffff", kwlist, &forward,
                                   &right, &brake, &handbrake)) {
    return NULL;
  }
