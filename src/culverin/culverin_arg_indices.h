...
#define SCHEMA_SBSS_CREATE_CONSTRAINTS(X)                                                          \
    X(IDX_SCC_COMP, "compliance", float, 1)                                                        \
    X(IDX_SCC_BEND, "bend_type", int, 0)

#define SCHEMA_SBSS_ADD_VERTICES(X)                                                                \
    X(IDX_SAVS_POS, "positions", PyObject *, 1)                                                    \
    X(IDX_SAVS_MASS, "inv_masses", PyObject *, 0)

#define SCHEMA_SBSS_ADD_FACES(X) X(IDX_SAFS_IND, "indices", PyObject *, 1)

#define SCHEMA_GET_SB_VERTEX(X)                                                                    \
    X(IDX_GSBV_H, "handle", ParseBodyHandle, 1)                                                    \
    X(IDX_GSBV_I, "index", uint32_t, 1)
...
#define SCHEMA_CREATE_SOFT_BODY(X)                                                                 \
    ...
    X(IDX_CSB_PRESSURE, "pressure", float, 0)                                                      \
    X(IDX_CSB_V_RADIUS, "vertex_radius", float, 0)                                                 \
    X(IDX_CSB_LIN_DAMP, "linear_damping", float, 0)                                                \
    X(IDX_CSB_ITER, "num_iterations", uint32_t, 0)                                                 \
    X(IDX_CSB_MAX_VEL, "max_linear_velocity", float, 0)                                            \
...
#define SCHEMA_REG_SYNC_PHYS(X)                                                                    \
    X(IDX_RSP_WORLD, "world", PyObject *, 1)                                                       \
    X(IDX_RSP_H_COMP, "handle_comp_id", uint32_t, 1)                                               \
    X(IDX_RSP_T_COMP, "transform_comp_id", uint32_t, 1)

#define SCHEMA_MATH_PERSPECTIVE(X)                                                                 \
    X(IDX_MP_FOVY, "fovy", float, 1)                                                               \
    X(IDX_MP_ASPECT, "aspect", float, 1)                                                           \
    X(IDX_MP_NEAR, "near", float, 1)                                                               \
    X(IDX_MP_FAR, "far", float, 1)

#define SCHEMA_MATH_ORTHO(X)                                                                       \
    X(IDX_MO_LEFT, "left", float, 1)                                                               \
    X(IDX_MO_RIGHT, "right", float, 1)                                                             \
    X(IDX_MO_BOTTOM, "bottom", float, 1)                                                           \
    X(IDX_MO_TOP, "top", float, 1)                                                                 \
    X(IDX_MO_NEAR, "near", float, 1)                                                               \
    X(IDX_MO_FAR, "far", float, 1)

#define SCHEMA_MATH_TRIO(X)                                                                        \
    X(IDX_MT_0, "arg0", PyObject *, 1)                                                             \
    X(IDX_MT_1, "arg1", PyObject *, 1)                                                             \
    X(IDX_MT_2, "arg2", PyObject *, 1)

#define SCHEMA_STRESS_TEST(X)                                                                      \
    X(IDX_0, "a0", uint64_t, 0)                                                                    \
    X(IDX_1, "a1", uint64_t, 0)                                                                    \
    X(IDX_2, "a2", uint64_t, 0)                                                                    \
    X(IDX_3, "a3", uint64_t, 0)                                                                    \
    X(IDX_4, "a4", uint64_t, 0)                                                                    \
    X(IDX_5, "a5", uint64_t, 0)                                                                    \
    X(IDX_6, "a6", uint64_t, 0)                                                                    \
    X(IDX_7, "a7", uint64_t, 0)                                                                    \
    X(IDX_8, "a8", uint64_t, 0)                                                                    \
    X(IDX_9, "a9", uint64_t, 0)                                                                    \
    X(IDX_10, "a10", uint64_t, 0)                                                                  \
    X(IDX_11, "a11", uint64_t, 0)                                                                  \
    X(IDX_12, "a12", uint64_t, 0)                                                                  \
    X(IDX_13, "a13", uint64_t, 0)                                                                  \
    X(IDX_14, "a14", uint64_t, 0) X(IDX_15, "a15", uint64_t, 0) X(IDX_16, "a16", uint64_t, 0) X(   \
        IDX_17, "a17", uint64_t, 0) X(IDX_18, "a18", uint64_t, 0) X(IDX_19, "a19", uint64_t, 0)    \
        X(IDX_20, "a20", uint64_t, 0) X(IDX_21, "a21", uint64_t, 0) X(IDX_22, "a22", uint64_t, 0)  \
            X(IDX_23, "a23", uint64_t, 0) X(IDX_24, "a24", uint64_t, 0)                            \
                X(IDX_25, "a25", uint64_t, 0) X(IDX_26, "a26", uint64_t, 0)                        \
                    X(IDX_27, "a27", uint64_t, 0) X(IDX_28, "a28", uint64_t, 0)                    \
                        X(IDX_29, "a29", uint64_t, 0) X(IDX_30, "a30", uint64_t, 0)                \
