...
#define SCHEMA_STRESS_TEST(X)                                                                      \
    ...
    X(IDX_8, "a8", uint64_t, 0) X(IDX_9, "a9", uint64_t, 0) X(IDX_10, "a10", uint64_t, 0) X(       \
        IDX_11, "a11", uint64_t, 0) X(IDX_12, "a12", uint64_t, 0) X(IDX_13, "a13", uint64_t, 0)    \
        X(IDX_14, "a14", uint64_t, 0) X(IDX_15, "a15", uint64_t, 0) X(IDX_16, "a16", uint64_t, 0)  \
            X(IDX_17, "a17", uint64_t, 0) X(IDX_18, "a18", uint64_t, 0)                            \
                    ...
                    X(IDX_21, "a21", uint64_t, 0) X(IDX_22, "a22", uint64_t, 0)                    \
                        X(IDX_23, "a23", uint64_t, 0) X(IDX_24, "a24", uint64_t, 0)                \
                            X(IDX_25, "a25", uint64_t, 0) X(IDX_26, "a26", uint64_t, 0) X(         \
                                ...
                                X(IDX_29, "a29", uint64_t, 0) X(IDX_30, "a30", uint64_t, 0) X(     \
                                    IDX_31, "a31", uint64_t, 0) X(IDX_32, "a32", uint64_t, 0)      \
                                    X(IDX_33, "a33", uint64_t, 0) X(IDX_34, "a34", uint64_t, 0) X( \
                                        IDX_35, "a35", uint64_t, 0) X(IDX_36, "a36", uint64_t, 0)  \
