...
#define SCHEMA_STRESS_TEST(X)                                                                      \
    ...
    X(IDX_9, "a9", uint64_t, 0) X(IDX_10, "a10", uint64_t, 0) X(IDX_11, "a11", uint64_t, 0) X(     \
        IDX_12, "a12", uint64_t, 0) X(IDX_13, "a13", uint64_t, 0) X(IDX_14, "a14", uint64_t, 0)    \
        X(IDX_15, "a15", uint64_t, 0) X(IDX_16, "a16", uint64_t, 0) X(IDX_17, "a17", uint64_t, 0)  \
                ...
                X(IDX_20, "a20", uint64_t, 0) X(IDX_21, "a21", uint64_t, 0)                        \
                    X(IDX_22, "a22", uint64_t, 0) X(IDX_23, "a23", uint64_t, 0)                    \
                        X(IDX_24, "a24", uint64_t, 0) X(IDX_25, "a25", uint64_t, 0)                \
                            X(IDX_26, "a26", uint64_t, 0) X(IDX_27, "a27", uint64_t, 0) X(         \
                                IDX_28, "a28", uint64_t, 0) X(IDX_29, "a29", uint64_t, 0)          \
                                                  ...
                                                  0) X(IDX_49, "a49", uint64_t,                    \
                                                    ...
                                                    X(IDX_53, "a53", uint64_t,                     \
                                                      0) X(IDX_54, "a54", uint64_t,                \
                                                           0) X(IDX_55, "a55", uint64_t, 0)        \
                                                        X(IDX_56, "a56", uint64_t,                 \
                                                          0) X(IDX_57, "a57", uint64_t,            \
                                                               0) X(IDX_58, "a58", uint64_t, 0)    \
                                                            X(IDX_59, "a59", uint64_t,             \
                                                              0) X(IDX_60, "a60", uint64_t, 0)     \
                                                                X(IDX_61, "a61", uint64_t,         \
                                                                  0) X(IDX_62, "a62", uint64_t, 0) \
