...
PyCFunction_DeclareMethodFromModule Skeleton_get_joint_index(SkeletonObject *self, PyObject *args);

PyCFunction_DeclareMethodFromModule Skeleton_finalize(SkeletonObject *self, PyObject *args);

PyCFunction_DeclareMethodFromModule PhysicsWorld_create_ragdoll_settings(struct PhysicsWorldObject *self,
                                               PyObject *args);
...
PyCFunction_DeclareMethodFromModule PhysicsWorld_create_ragdoll(struct PhysicsWorldObject *self,
...
PyType_DeclareSlot_ObjectFromModule Skeleton_new(PyTypeObject *type, PyObject *args, PyObject *kwds);
